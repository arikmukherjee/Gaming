"""
3D Transformations (Template)

This template extends the user's original program and includes:
- Translation
- Scaling
- Rotation (X, Y, Z)
- Shearing submenu (X, Y, Z, XY, YZ, XZ, XYZ)
- Reflection submenu (XY, YZ, ZX planes, X, Y, Z axes, Origin)

NOTE:
This is provided as a downloadable starter because the complete inline
version exceeds the chat response size limit.
"""
